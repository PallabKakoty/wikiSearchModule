...
function displayResults(data) {
  ...
  result.forEach(result => {
    ...
    //const downlogo = @routes.Assets.versioned("images/favicon.png");

  console.log('@routes.Assets.versioned("images/favicon.png")');
    console.log(result.title)
    const pdfurl = `wsaction?title=${result.title.replace(/ /g, "_")}`
    resultsContainer.insertAdjacentHTML("beforeend",
      `<div class='resultItem'>
        <h3 class='resultItem-title'>
          <a href=${url} target='_blank'>${result.title}</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b><a href=${pdfurl} id="downloadA" target="_blank" style="font-size: 13px; text-align:right;">Download As PDF &#8595;</a></b>
        </h3>
